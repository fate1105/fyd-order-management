...
export default function Sidebar() {
  return (
    <aside className="sidebar">
      ...
      <div className="navGroupTitle">MARKETING</div>
      <div className="navGroup">
        <Item to="/admin/featured" icon={icons.featured} label="Nổi bật" />
        <Item to="/admin/promotions" icon={icons.products} label="Khuyến mãi" />
        <Item to="/admin/tiers" icon={icons.customers} label="Hạng thành viên" />
      </div>
